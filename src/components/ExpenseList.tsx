    ...
    <div className="space-y-4">
      {expenses.map((expense, index) => {
        ...
        return (
          <Card 
            key={expense.id}
            className="card-glass rounded-xl p-6 hover-lift hover-glow stagger-item transition-all duration-300 border border-border/30 group"
              ...
              <div className="flex items-center gap-5 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1 space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    {expense.merchant && (
                      <Badge variant="secondary" className="text-sm font-semibold px-3 py-1 bg-secondary/20">
                        {expense.merchant}
                      </Badge>
                    )}
                  </div>
